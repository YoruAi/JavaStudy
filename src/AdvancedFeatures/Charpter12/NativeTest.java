package AdvancedFeatures.Charpter12;

public class NativeTest {
    // 使用javac -h . *.java自动在目录内生成头文件，根据提供函数编写c程序
    // 编译：
    // gcc -fPIC -I "jdk\include" -I "jdk\include\win32" -shared
    // -o AdvancedFeatures_Charpter12_NativeTest.dll/lib?.so AdvancedFeatures_Charpter12_NativeTest.c
    // 运行：
    ...
    \Charpter12\resources" AdvancedFeatures.Charpter12.NativeTest
     */

    static {
        System.loadLibrary("AdvancedFeatures_Charpter12_NativeTest");
    }
